"""LearnFlow Progress Agent Service."""
...
app = FastAPI(title="Progress Agent", version="1.0.0")
agent = Agent()
    ...
    try:
        async with httpx.AsyncClient() as client:
            await client.post(
                ...
                json={"user_id": request.user_id, "agent": "progress-agent", "action": "chat"},
            )
